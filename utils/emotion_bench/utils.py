...
def run_emotionbench(args, generator):
    ...
    args.scenarios_file = f'situations/{args.mbti}-{questionnaire_name}-situations.csv' if args.mbti is not None else f'situations/{args.model}-{questionnaire_name}-situations.csv'
    args.testing_file = f'results/{args.mbti}-{questionnaire_name}-testing.csv' if args.mbti is not None else f'results/{args.model}-{questionnaire_name}-testing.csv'
    args.results_file = f'results/{args.mbti}-{questionnaire_name}-results' if args.mbti is not None else f'results/{args.model}-{questionnaire_name}-results'
