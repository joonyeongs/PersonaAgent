...
--beta 0.2  \
--output_dir /home/vqa/model-weights/llama2/annotated/infp/full \
--epoch 5 \
--mbti INFP \
...
--beta 0.2  \
--output_dir /home/vqa/model-weights/llama2/annotated/infj/full \
--epoch 5 \
--mbti INFJ \
--model_path unsloth/llama-2-7b-chat \
...
--beta 0.2  \
--output_dir /home/vqa/model-weights/llama2/annotated/entj/full \
--epoch 5 \
--mbti ENTJ \
--model_path unsloth/llama-2-7b-chat \
#--model_path /home/vqa/model-weights/llama3/annotated/infp/ablation/checkpoint-33 \
...
--beta 0.2  \
--output_dir /home/vqa/model-weights/llama2/annotated/estj/full \
--epoch 5 \
--mbti ESTJ \
--model_path unsloth/llama-2-7b-chat \
#--model_path /home/vqa/model-weights/llama3/annotated/infp/ablation/checkpoint-33 \
